        ...
        <div class="col-lg-6">
        	<div class="mt-4">
    			<div class="content-panel">
	           	 	<div class="m-4">
	           		<form class="validation-form" id="contactfrm" name="contactfrm" action="/mail1" method="POST" novalidate>
		           	<label>문의유형</label>
		    	...
		    	<table class="table table-bordered table-striped table-condensed cf">
	              ...
	              <div class="form-send w3-center">
	                <button type="submit" class="btn btn-theme" href="contact">문의하기</button>
	              </div>	
	            </form>
	          </div>
	        </div>
