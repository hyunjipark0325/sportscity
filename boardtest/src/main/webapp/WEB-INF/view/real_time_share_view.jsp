				...
				<div class="col-lg-8">
					<div class="row mb">
						...
						<form action="#" class="form-horizontal style-form validation-form" method="" novalidate>
			               ...
			               <div>
			               <table style="width:300px; height:50px; font-weight:bold;">
			                <tbody> 
			                  <tr>
			                    <td style="text-align:left">2022.8.5</td>
			                    <td style="text-align:left">18:00</td>
			                    <td style="text-align:left">서울시 강남구 역삼동</td>
			                  </tr>
			                  <tr>
			                    <td style="text-align:left"><i class="fa-solid fa-cloud-showers-heavy"></i> 비</td>
			                    <td style="text-align:left"><i class="fa-solid fa-wind"></i> 바람</td>
			               ...
			               <div style="height: 500px; margin:5%;"> 
			               <img src="css/img/rain.jpg" alt="" width="500">
			               </div>
			               ...
			               <a href=#><img src="css/img/kakaotalk_sharing_btn_medium.png" alt="" width="30"></a>
				               ...
				               <button class="btn btn-light"><a href="real_time_share">목록</a></button>
				             </div>         			                
				             <div class="form-send w3-right m-3">
				               <button type="submit" class="btn btn-theme"><a href="real_time_share_modify">수정</a></button>
