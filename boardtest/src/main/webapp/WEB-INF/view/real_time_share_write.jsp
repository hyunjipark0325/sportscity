						...
						<form action="#" class="form-horizontal style-form validation-form" method="" novalidate>
			                ...
			                <div class="form-group">
			                  ...
			                  <label class="checkbox-inline-block" required>
				                <input class="m-1" type="checkbox" id="#" value="맑음"><i class="fa-solid fa-sun"></i> 맑음
				                <input class="m-1" type="checkbox" id="#" value="흐림"><i class="fa-solid fa-cloud"></i> 흐림
				                <input class="m-1" type="checkbox" id="#" value="바람"><i class="fa-solid fa-wind"></i> 바람
				                <input class="m-1" type="checkbox" id="#" value="비"><i class="fa-solid fa-cloud-showers-heavy"></i> 비
				                <input class="m-1" type="checkbox" id="#" value="눈"><i class="fa-solid fa-snowflake"></i> 눈
				                <input class="m-1" type="checkbox" id="#" value="미세먼지"><i class="fa-solid fa-smog"></i> 미세먼지
				              </label>
			                ...
			                <div class="form-send w3-left m-3">
				               <button class="btn btn-light"><a href="real_time_share">취소</a></button>
				             </div>
